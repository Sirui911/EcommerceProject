...
import com.coseller.utility.USConstants;
...
//	}
	...
	public String myProfile(Model model, Principal principal) {
		...
		model.addAttribute("addPaymentList", user.getUserPaymentList());
		model.addAttribute("addShippingList", user.getUserShippingList());
//		model.addAttribute("orderList", user.getOrderList());
		...
		model.addAttribute("classActive", true);
	...
	public String addNewCreditCard(Model model, Principal principal) {
		...
		model.addAttribute("classActiveBilling", true);
		model.addAttribute("listOfShipping)Addresses", true);
...
//			model.addAttribute("orderList", user.getOrderList);
	...
	public String updateUserShipping(
		...
		if (user.getId() != userShipping.getUser().getId()) {
			...
			//此时显示的tab，因为要update，所以显示new的页面而不是shipping list，但是换去billing过要显示creditcard的list，然后现在是shipping是active的
			model.addAttribute("addNewShippingAddress", true);
			model.addAttribute("classActiveShipping", true);
			model.addAttribute("listOfCreditCards", true);
		}
	...
	public String setDefaultPayment(
		...
		model.addAttribute("userPaymentList", user.getUserPaymentList());
		model.addAttribute("userShippingList", user.getUserShippingList());
		//model.addAttribute("lorderLsit", user.getOrderList());
	...
	public String setDefaultShippingAddress(
			@ModelAttribute("defaultShippingAddressId") Long defaultShippingAddressId, Model model, Principal principal
			) {
		User user = userService.findByUsername(principal.getName());
		userService.setDefaultShippingAddress(defaultShippingAddressId, user);
	...
	public String forgetPassword(
		...
		model.addAttribute("forgetPasswordEmailSnet", "true");
	...
	public String newUserPost(
		...
		//if the username and email are not duplicated, create a new user
		//setusername
		User user = new User();
	...
	public String newUser(Locale locale, @RequestParam("token") String token, Model model) {
		...
		// if the token is valid, the user can be found with the token
		User user = passToken.getUser();
		String username = user.getUsername();

		// set current login session to this user.the following three santence
